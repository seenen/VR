...
public class OBJ : MonoBehaviour
{
	...
	public IEnumerator Load(string path)
    {
        ...
        Debug.Log("Load " + (System.DateTime.Now.Ticks - before) / 10000000.0);
    }

    public void LoadeFile(string path)
    {
        ...
        Debug.Log("LoadeFile " + (System.DateTime.Now.Ticks - before) / 10000000.0);
    }
